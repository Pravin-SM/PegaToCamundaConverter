...
public class FlowNodeInfo8 {
    ...
    public FlowNodeInfo8(String id, Double originalXInput, Double originalYInput, Double calcXInput, Double calcYInput, String typeInput, Double height, Double width) {
        newFlowNodeID = id;
