...
public class DrawFlow8 {

    public static BpmnPlane drawFlow(BpmnPlane plane, ModelInstance modelInstance, SequenceFlow sequenceFlow, FlowNodeInfo8 source, FlowNodeInfo8 target, NodeList sequenceCurveList, Double subProcessXOffset, Double subProcessYOffset) {
